                        ...
                        <div class="service-details__sidebar">
                            <div class="service-details__sidebar-service">
                                <ul class="service-details__sidebar-service-list list-unstyled">
                                    ...
                                    <li><a href="{{route("itSolutions")}}">IT Solutions<span
                                                class="icon-right-arrow"></span></a></li>
                                    <li class="current"><a href="{{route("financeSolutions")}}">Finance Solutions<span
                                                class="icon-right-arrow"></span></a></li>
                                </ul>
                            </div>
                    ...
                    <div class="col-xl-8 col-lg-7">
                        <div class="service-details__right">
                            <div class="service-details__img">
                                <img src="{{asset("images/services/services-1-4.png")}}" style="width: 400px !important;" alt="">
                            </div>
                            <div class="service-details__content">
                                <div class="service-details__title-box">
                                    ...
                                    <h3 class="service-details__title">Finance Solutions</h3>
                                </div>
                            </div>
                            <ul class="custom-list">
                                <li>Banking and financial services</li>
                                <li>Mortgage and credit card solutions</li>
                                <li>Payment processing and tax preparation</li>
                                <li>Accounting and investment management</li>
                            </ul>
                        </div>
                    </div>
                </div>
