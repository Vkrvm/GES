...
<body>
    ...
    <div class="page-wrapper">
        ...
        <nav class="main-menu clearfix">
            ...
            <div class="main-menu-wrapper__left">
                ...
                <a href="index-2.html"><img src="{{asset("images/logo/Logo GES-01.png")}}" height="180" alt="logo" /></a>
                </div>
                ...
                <ul class="main-menu__list">
                    ...
                    <li class="{{ Route::is('contactus') ? 'current' : '' }}"><a href="{{route("contactus")}}">Contact Us</a></li>
                </ul>
                </div>
            </div>
        ...
        <div class="site-footer__top">
            ...
            <div class="row">
                ...
                <div class="footer-widget__column footer-widget__about">
                    ...
                    <a href="index-2.html"><img src="{{asset("images/logo/Logo GES-01.png")}}" height="100" alt /></a>
                    </div>
                    ...
                    <a href="https://www.instagram.com/ges_advertising_agency?igsh=MXI3cXVrZG56dGQ4NQ=="><i
                        class="fab fa-instagram"></i></a>
                    <a href="https://www.linkedin.com/company/ges-for-advertising-and-corprate-solutions/"><i
    ...
    <div class="mobile-nav__wrapper">
        ...
        <div class="logo-box">
            <a href="index-2.html" aria-label="logo image"><img src="{{asset("images/logo/Logo GES-01.png")}}" height="180"
                alt /></a>
        </div>
        <!-- /.logo-box -->
