            ...
            <div class="benefits-one__left">
              <div class="section-title text-left">
                <ul class="list-unstyled benefits-one__points">
                  <li>
                    <div class="icon">
                      <span><img src="{{asset("images/icon/vision.png")}}" alt="" width="64" height="64"></span>
                      <p>Vision</p>
                    </div>
                    <div class="text">
                      <p>
                  ...
                  <li>
                    <div class="icon">
                      <span><img src="{{asset("images/icon/mission.png")}}" alt="" width="64" height="64"></span>
                      <p>Mission</p>
                    </div>
                    <div class="text">
                      <p>
            ...
            <ul class="list-unstyled trusted-one__content-box row">
              <li class="trusted one__single wow fadeInLeft col-xl-6 m-0" data-wow-delay="100ms">
                <div class="trusted-one__icon">
                  <span><img src="{{asset("images/icon/chart-line-up (1).png")}}" alt="line chart" width="23"
                      height="23"></span>
                </div>
